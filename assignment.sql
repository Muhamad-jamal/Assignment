...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2025 at 05:18 PM
...
(4, '2025_09_22_201530_create_personal_access_tokens_table', 1),
(5, '2025_09_23_121302_create_positions_table', 1),
(6, '2025_09_23_121329_create_employees_table', 1),
(7, '2025_09_23_121347_create_salary_histories_table', 1),
(8, '2025_09_23_211047_create_logs_table', 1);
...
ALTER TABLE `employees`
  ...
  ADD KEY `employees_salary_index` (`salary`);
...
ALTER TABLE `salary_histories`
  ...
  ADD KEY `salary_histories_changed_by_foreign` (`changed_by`),
  ADD KEY `salary_histories_changed_at_index` (`changed_at`);
...
--
ALTER TABLE `salary_histories`
  ADD CONSTRAINT `salary_histories_changed_by_foreign` FOREIGN KEY (`changed_by`) REFERENCES `users` (`id`) ON DELETE CASCADE,
